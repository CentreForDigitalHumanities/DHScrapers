...
In this virtualenv, from the project root folder, simply run `pip install -r requirements.txt`. Once this is done, start the virtualenv, and you're good to go!
